...
import { JobMatchBoard } from "@/components/jobs/job-match-board";
...
export const metadata: Metadata = {
  title: "Jobs",
  description:
    "Explore mock AnalystOS job matches by role, location, and skill with recommended portfolio projects before applying.",
  alternates: {
    canonical: "/jobs",
  },
};
      ...
      <Container className="relative pb-24 pt-14 lg:pb-28 lg:pt-20">
        <section className="mx-auto mb-10 max-w-4xl text-center lg:mb-14">
          ...
          <h1 className="mt-7 text-5xl font-semibold leading-[0.98] tracking-[-0.05em] text-white lg:text-7xl">
            Match job targets to portfolio proof.
          </h1>
          <p className="mx-auto mt-6 max-w-2xl text-base leading-8 text-slate-300/[0.78] lg:text-lg">
            Browse a mock job board that shows fit by role, location, and skill,
            then see which AnalystOS projects to complete before applying.
          </p>
        </section>
