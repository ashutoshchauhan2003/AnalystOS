...
import { premiumEase, premiumHover, premiumTap } from "@/components/motion/presets";
      ...
      <div className="grid gap-4 lg:grid-cols-[320px_minmax(0,1fr)]">
        <div className="pointer-events-auto">
          <GlassPanel className="bg-[linear-gradient(180deg,rgba(255,255,255,0.09),rgba(255,255,255,0.03))] p-5" glow="blue">
            ...
            <div className="mt-5 rounded-[1.2rem] border border-white/[0.08] bg-[linear-gradient(180deg,rgba(255,255,255,0.06),rgba(255,255,255,0.02))] px-4 py-4 shadow-[inset_0_1px_0_rgba(255,255,255,0.04)]">
              ...
              <div className="flex flex-wrap gap-3">
                <div
                  className={cn(
                    ...
                    activeStation.accent === "cyan"
                      ? "border-cyan-300/[0.22] bg-cyan-300/10"
                      : "border-indigo-300/[0.22] bg-indigo-300/10",
                    accentGlow,
                  )}
                >
      ...
      <div className="grid gap-4 lg:grid-cols-[320px_minmax(0,1fr)_380px]">
            ...
            <div className="mt-5 space-y-2.5">
              {labStations.map((station, index) => (
                <motion.button
                  ...
                  whileHover={station.id === activeStationId ? undefined : { y: -2 }}
                  whileTap={premiumTap}
        ...
        <div className="pointer-events-none hidden items-end justify-center lg:flex">
          <motion.div
            ...
            className="rounded-full border border-white/10 bg-slate-950/[0.55] px-5 py-3 text-xs uppercase tracking-[0.28em] text-slate-300 backdrop-blur-xl"
          >
          ...
          >
            ...
            <AnimatePresence mode="wait">
              ...
              >
                ...
                <p className="mt-4 text-base leading-8 text-slate-300/[0.76]">
                  {activeStation.title}
                </p>
                ...
                <div className="mt-6 grid gap-3 sm:grid-cols-3">
                  {activeStation.overlayKpis.map((item) => (
                    <motion.div
                      ...
                      className="rounded-[1.2rem] border border-white/[0.08] bg-[linear-gradient(180deg,rgba(255,255,255,0.05),rgba(255,255,255,0.02))] px-4 py-4 shadow-[inset_0_1px_0_rgba(255,255,255,0.04)]"
                    >
                ...
                <div className="mt-6 space-y-3">
                  {activeStation.detailLines.map((line, index) => (
                    <div
                      key={line}
                      className="flex items-center gap-3 rounded-[1.15rem] border border-white/[0.08] bg-[linear-gradient(180deg,rgba(255,255,255,0.05),rgba(255,255,255,0.02))] px-4 py-3.5 shadow-[inset_0_1px_0_rgba(255,255,255,0.04)]"
                    >
                ...
                <div className="mt-6 space-y-3">
                  {activeStation.overlayNotes.map((note) => (
                    <div
                      key={note}
                      className="rounded-[1.15rem] border border-white/[0.08] bg-white/[0.03] px-4 py-3 text-sm leading-7 text-slate-300"
                    >
                      {note}
                    </div>
                  ))}
