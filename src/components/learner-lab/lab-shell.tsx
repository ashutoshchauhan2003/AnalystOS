...
export function LabShell({ children, className }: LabShellProps) {
  return (
    ...
    >
      ...
      <div className="pointer-events-none absolute left-[-10%] top-[16%] h-80 w-80 rounded-full bg-cyan-400/[0.07] blur-[140px]" />
      <div className="pointer-events-none absolute right-[-6%] top-[28%] h-72 w-72 rounded-full bg-indigo-400/[0.08] blur-[130px]" />
