  ...
  return (
    <div
      className={cn(
        ...
        glow === "cyan" &&
          "before:absolute before:inset-x-10 before:top-0 before:h-px before:bg-cyan-300/[0.45] before:content-[''] after:absolute after:-right-14 after:top-8 after:h-28 after:w-28 after:rounded-full after:bg-cyan-400/[0.08] after:blur-3xl after:content-['']",
        glow === "blue" &&
          "before:absolute before:inset-x-10 before:top-0 before:h-px before:bg-sky-200/[0.35] before:content-[''] after:absolute after:-left-10 after:bottom-0 after:h-24 after:w-24 after:rounded-full after:bg-indigo-400/[0.08] after:blur-3xl after:content-['']",
        glow === "none" &&
      ...
      {...props}
    >
      <div className="pointer-events-none absolute inset-[1px] rounded-[25px] border border-white/[0.06]" />
