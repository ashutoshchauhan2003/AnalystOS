...
export function WorkspaceShell({ children, className }: WorkspaceShellProps) {
  return (
    <main
      className={cn(
        "relative h-dvh overflow-hidden bg-[linear-gradient(180deg,#07111d_0%,#050a14_45%,#04070f_100%)] text-slate-50",
        className,
      )}
    >
      ...
      <div className="relative mx-auto flex h-full max-w-[1660px] flex-col px-5 py-5 lg:px-7 lg:py-6">
        {children}
      </div>
    </main>
  );
