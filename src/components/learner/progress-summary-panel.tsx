  ...
  return (
    <Reveal delay={0.08}>
      <GlassPanel className="h-full bg-[linear-gradient(180deg,rgba(255,255,255,0.085),rgba(255,255,255,0.03))] p-7 lg:p-8" glow="cyan">
        ...
        <p className="text-[11px] uppercase tracking-[0.34em] text-cyan-200/[0.72]">Progress Summary</p>
        ...
        <div className="mt-8 rounded-[1.4rem] border border-cyan-300/[0.14] bg-[linear-gradient(180deg,rgba(34,211,238,0.12),rgba(34,211,238,0.05))] p-4 shadow-[inset_0_1px_0_rgba(255,255,255,0.04)]">
