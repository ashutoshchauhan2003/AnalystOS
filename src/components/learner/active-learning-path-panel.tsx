      ...
      >
        ...
        <div className="flex items-start justify-between gap-6">
          <div>
            ...
            <p className="mt-5 max-w-2xl text-base leading-8 text-slate-300/[0.76]">
            ...
            >
              <div className="flex items-center justify-between gap-4">
                <div className="flex items-center gap-4">
                  <span className="flex h-8 w-8 items-center justify-center rounded-full border border-cyan-300/[0.14] bg-cyan-300/[0.08] text-[10px] uppercase tracking-[0.32em] text-cyan-100/80">
                    0{index + 1}
                  </span>
                  <div>
