      ...
      <Container>
        <div className="grid gap-12 lg:grid-cols-[0.9fr_1.1fr]">
          ...
          <div className="grid gap-4 md:grid-cols-3">
            {trustStats.map((stat, index) => (
              <Reveal key={stat.label} delay={index * 0.08} hover="lift">
                <GlassPanel
                ...
                >
                  ...
                  <p className="mt-3 text-sm leading-6 text-slate-300/[0.72]">{stat.label}</p>
                </GlassPanel>
              </Reveal>
            ))}
          </div>
        ...
        <div className="mt-16 grid gap-6 lg:grid-cols-2">
          {testimonials.map((item, index) => (
            <Reveal key={item.name} delay={index * 0.12} hover="lift">
              <GlassPanel
              ...
              >
                ...
                <p className="text-[1.15rem] leading-9 text-slate-100/[0.92]">
                ...
                <div className="mt-10 flex items-end justify-between gap-6">
                  ...
                  <div className="max-w-[220px] rounded-[1.15rem] border border-white/[0.08] bg-white/[0.03] px-4 py-3 text-right shadow-[inset_0_1px_0_rgba(255,255,255,0.04)]">
                    <p className="text-[11px] uppercase tracking-[0.28em] text-cyan-200/70">
                      Outcome
                    </p>
                    <p className="mt-2 text-sm leading-6 text-slate-300/[0.72]">{item.outcome}</p>
                  </div>
                </div>
              </GlassPanel>
            </Reveal>
